        ...
        <div className="max-w-5xl mx-auto space-y-6">
            ...
            >
                ...
                <div className="relative z-10 flex items-center justify-between">
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight mb-2">Welcome, {parentName}</h2>
                        <p className="text-indigo-200 max-w-lg">
                            Monitor your children's academic progress, attendance, and upcoming school events all in one place.
                        </p>
                    </div>
            ...
            <h3 className="text-xl font-bold text-slate-800 pt-4 px-1">Linked Children</h3>
                        ...
                        <div className="flex items-start justify-between mb-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-medium text-slate-500">{child.grade || 'Grade Not Assigned'}</p>
                                </div>
                            </div>
                        </div>
